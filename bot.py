...
async def start(event):
  await event.reply("**Ben Tagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/MuzikDiyarixx?startgroup=a'),
                      Button.url('📣 Geliştirici', 'https://t.me/MuzikDiyarixx')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @Atabey27 bilgi alabilirsin <<")
